          ...
          <div className="flex flex-col lg:flex-row gap-16 items-center">
            ...
            <div className="lg:w-1/2 space-y-8">
              ...
              <div className="flex flex-wrap gap-4 pt-4">
                <a className="inline-flex items-center justify-center text-white font-bold text-lg px-10 py-5 rounded-full bg-emerald-500 hover:bg-emerald-600 hover:-translate-y-1 hover:shadow-[0_20px_40px_rgba(16,185,129,0.3)] transition-all" href="#calendly">
                  Get Free Tech Audit
                </a>
      ...
      <section id="stack" className="py-24 bg-[#f8fafc] relative border-t border-slate-200">
        <div className="container mx-auto px-6 max-w-7xl">
          <div className="text-center max-w-3xl mx-auto mb-16 space-y-4">
            <span className="text-emerald-600 font-bold tracking-widest uppercase text-sm">Platforms & Technologies</span>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              { icon: ShoppingBag, title: 'Shopify Development', desc: 'Custom themes, headless commerce, and app integrations to build high-converting e-commerce machines.', gradient: 'from-emerald-400 to-teal-500', shadow: 'shadow-teal-500/30' },
              { icon: LayoutDashboard, title: 'WordPress & CMS', desc: 'Highly customizable, SEO-friendly, and easy-to-manage content systems for blogs and corporate sites.', gradient: 'from-blue-400 to-indigo-500', shadow: 'shadow-blue-500/30' },
              ...
              { icon: Smartphone, title: 'UI/UX Design', desc: 'User-centric wireframes and stunning interfaces designed in Figma to guarantee smooth customer journeys.', gradient: 'from-purple-400 to-pink-500', shadow: 'shadow-pink-500/30' },
              { icon: Link2, title: 'API & Integrations', desc: 'Connecting your CRM, payment gateways, and third-party software for seamless automated operations.', gradient: 'from-amber-400 to-orange-500', shadow: 'shadow-orange-500/30' }
            ].map((v, i) => (
      ...
      <section className="py-24 bg-[#f8fafc] border-b border-slate-200">
        <div className="container mx-auto px-6 max-w-4xl">
          <div className="text-center mb-16 space-y-4">
            <span className="text-emerald-600 font-bold tracking-widest uppercase text-sm">FAQ</span>
        ...
        <div className="container mx-auto px-6 max-w-7xl">
          ...
          <div className="flex flex-col md:flex-row gap-12 bg-slate-50 rounded-[2.5rem] p-8 md:p-12 border border-slate-200 shadow-xl">
              ...
              <div className="space-y-6">
                {[
                  ...
                  <div key={i} className="flex gap-4 items-start">
                    <span className="text-emerald-500 font-black text-xl">{item.num}</span>
                    <div>
            ...
            <div className="md:w-1/2 bg-white rounded-3xl p-8 border border-slate-200 shadow-md text-center flex flex-col justify-center">
              ...
              <div className="space-y-4">
                <a href="https://wa.me/919424995426" target="_blank" rel="noreferrer" className="flex items-center justify-center gap-2 w-full py-4 rounded-xl font-bold bg-emerald-500 text-white hover:bg-emerald-600 transition-colors shadow-md">
