        ...
        <div className="container mx-auto px-6 max-w-7xl">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              ...
              { icon: Settings, title: 'Technical SEO', desc: 'Improves website speed, crawlability, indexing, mobile performance, and security, helping search engines understand your site.', gradient: 'from-blue-500 to-blue-600', shadow: 'shadow-blue-500/30' },
